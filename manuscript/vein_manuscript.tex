...
artefacts underlying every number, table, and figure in this paper are publicly
available at
...
scripts that reproduce every reported result from the underlying public data.
All underlying blockchain and market data are public and were obtained from
Dune Analytics (\url{https://dune.com}), DefiLlama
(\url{https://defillama.com}), and Etherscan (\url{https://etherscan.io}), as
detailed in Section~\ref{sec:data}; no restricted or proprietary data were
used.
