...
Unlike the 2022 episodes (Terra/Luna, Celsius, FTX), which were rooted in
fundamental insolvency, the October~2025 cascade was largely \emph{mechanical}:
a mispricing in a centralised exchange's internal valuation
engine\footnote{The proximate trigger has been attributed to Binance's
unified-account margin system, which valued posted collateral (including USDe,
wBETH and BNSOL) using its own internal spot prices rather than external
oracles; see \url{https://www.ccn.com/education/crypto/ethena-usde-depeg-binance-crash-explained/}
...
funding-liquidity spiral operating at machine speed. A defining feature was architectural: decentralised
...
fragility.\footnote{USDe's price fell to roughly \$0.65 on Binance while
holding near \$1 on other venues and in DeFi, and remained redeemable as supply
...
and \url{https://www.coindesk.com/markets/2025/10/13/no-ethena-s-usde-didn-t-de-peg}.} Crucially for
