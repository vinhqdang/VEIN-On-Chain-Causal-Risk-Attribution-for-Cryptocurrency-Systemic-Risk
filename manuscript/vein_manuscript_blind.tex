...
\noindent\textbf{Availability of data and materials.} The complete
implementation, the real-data evaluation pipeline, and all result artefacts
underlying every number and figure in this paper will be made available in a
public repository upon publication; the repository link has been withheld
from this version to preserve the review process and has been provided to
the editor separately. All underlying blockchain and market data are public
and were obtained from Dune Analytics, DefiLlama, and Etherscan as detailed
