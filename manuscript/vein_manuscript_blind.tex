...
\cite{rigana2024neco,etesami2023tvdig}, $\pa(i)$ is specified from the ledger
...
ROC-AUC of $0.98$ and an average precision of $0.24$ (Table~\ref{tab:resval}),
...
\cite{ali2025anatomy,lim2026cascade}.
...
artefacts underlying every number, table, and figure in this paper will be
made available in a public repository upon publication; the repository link
has been withheld from this version to preserve the review process and has
been provided to the editor separately. All underlying blockchain and market
data are public and were obtained from Dune Analytics
(\url{https://dune.com}), DefiLlama (\url{https://defillama.com}), and
Etherscan (\url{https://etherscan.io}), as detailed in Section~\ref{sec:data};
no restricted or proprietary data were used.

\bmhead{Declarations}

\noindent\textbf{Ethics approval and consent to participate.} Not applicable:
this study uses only public, aggregated on-chain and market data and involves
no human subjects, human data, or animals.

\noindent\textbf{Consent for publication.} Not applicable.

\noindent\textbf{Availability of data and materials.} See the Data
...
\noindent\textbf{Authors' contributions.} Author information withheld for
peer review.
